            ...
            [
                ...
                },
                {
                    ...
                    "reason": (
                        ...
                        "on foundation-model/* and inference-profile/*, held by the "
                        "AgentCore runtime role and the task worker. That pair cannot be "
                        "narrowed: AGENT_MODEL_ID is a cross-region inference profile, so "
                        "invoking it authorizes against BOTH the profile ARN and the "
                        "underlying foundation-model ARN in whichever region it fans out "
                        "to, and the model is user-switchable at runtime via the in-app "
                        "picker. "
