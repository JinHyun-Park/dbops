...
The api/ Lambda code asset is sandboxed and MUST NOT import mcp_servers, so the
pricing logic is duplicated here (same pattern as aurora_pricing / dynamodb_pricing /
elasticache_pricing). Keep the two in sync.
"""
