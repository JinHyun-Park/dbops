        ...
        <div className="max-h-96 overflow-y-auto">
          <table className="w-full text-sm">
            <thead className="bg-zinc-900/50 border-b border-zinc-800 sticky top-0">
              <tr>
                <th className="text-left px-3 py-2 text-zinc-400 font-medium w-16">
                  PID
                </th>
                <th className="text-left px-3 py-2 text-zinc-400 font-medium w-24">
                  User
                </th>
                <th className="text-left px-3 py-2 text-zinc-400 font-medium w-24">
                  State
                </th>
                <th className="text-right px-3 py-2 text-zinc-400 font-medium w-24">
                  Duration
                </th>
                <th className="text-left px-3 py-2 text-zinc-400 font-medium w-32">
                  Wait
                </th>
              ...
              {items.map((q, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className={`px-3 py-2 font-mono text-xs ${stateColor}`}>
                      {q.state}
                    </td>
                    <td
                      className={`px-3 py-2 text-right font-mono text-xs ${durColor}`}
                    >
                      {fmtDuration(dur)}
                    </td>
