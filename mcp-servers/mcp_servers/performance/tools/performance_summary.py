...
def get_performance_summary_impl(
    ...
    sql = """
        SELECT
            ...
            (SELECT MAX(value) FROM metric_snapshots WHERE cluster_id = :cluster_id AND metric_type = 'db_connections' AND ts > NOW() - MAKE_INTERVAL(hours => :hours)) as peak_connections
    """
