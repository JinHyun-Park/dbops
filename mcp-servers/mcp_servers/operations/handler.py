...
TOOLS = {
    ...
    "set_docdb_profiler": {
        ...
        "description": (
            ...
            "system.profile collection. Read it with search_logs by passing "
            "log_group=\"/aws/docdb/{cluster_id}/profiler\" explicitly (the "
            "default is the cluster error log). The parameter group is SHARED, so every "
